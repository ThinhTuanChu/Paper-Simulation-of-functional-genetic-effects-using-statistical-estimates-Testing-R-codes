...
sampleOffspring <- function(idd=NULL,par1,par2,popid=NULL,fixedFactors=NULL,randomFactors=NULL) {
  ...
  temp1 <- rbinom(nSnp,1,0.5) +1
  temp_pat[temp1==1]=genoPar1[1,temp1==1]
  temp_pat[temp1==2]=genoPar1[2,temp1==2]

  temp1 <- rbinom(nSnp,1,0.5) +1
  temp_mat[temp1==1]=genoPar2[1,temp1==1]
  temp_mat[temp1==2]=genoPar2[2,temp1==2]
